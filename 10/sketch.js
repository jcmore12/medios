...
function preload(){
fondoJuego = loadImage("Fotos/pepe-01.jpg");
fondoInstru= loadImage("Fotos/pepe-02.jpg")
  fondoPierde= loadImage("Fotos/pero-03.jpg")
...
tamY = height / 4;
      ...
      } else if (touches[k].x > width / 4 && touches[k].x < width / 4*2 &&
        touches[k].y > height / 4 && touches[k].y > height / 4*2){
...
if(estado==3){
      ...
      image(fondoInstru,0,0,width,height)
       ...
       if(touches[d].x > width / 4 && touches[d].x < width / 4*2 &&
        touches[d].y > height / 4 && touches[d].y > height / 4*2){
       estado=1;
         
       }else if (touches[d].x > cuadros[10].x  && touches[d].x < cuadros[11].x&&
    ...
    if (timer == 0) {
      ...
      for (var m = 0; m < touches.length; m++) {
        if (touches[m].x > cuadros[ran].x && touches[m].x < cuadros[ran].x + cuadros[ran].tamX &&
          ...
          estado = 2;
      cuadros[ran].colorito = 0
      cuadros[ran2].colorito = 0
      cuadros[ran3].colorito = 0;
      cuadros[ran4].colorito = 0;
      cuadros[ran5].colorito =0;
        }
      
      else if (timerSecret== -2) {
        timer = 3;
        estadoTimer = 0;
        timerSecret = 3;
