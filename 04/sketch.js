//Variables botones herramientas
...
function draw() {
  ...
  //Lineas separacion herramientas y canvas
  stroke(0);
  line(100, 0, 100, height);
  line(600, 0, 600, height);

  //Cuadros de las herramientas
  ...
  if (mouseIsPressed) {
    ...
    if (mouseX > posXborr - (tamBorr / 2) && mouseX < posXborr + (tamBorr / 2) &&
      mouseY > posYborr - (tamBorr / 2) && mouseY < posYborr + (tamBorr / 2)) {
      forma = 11;
    }

    //Espacio de seleccion de color
  ...
  if (mouseX > posXcol2 - (tamCol2 / 2) && mouseX < posXcol2 + (tamCol2 / 2) &&
    mouseY > posYcol2 - (tamCol2 / 2) && mouseY < posYcol2 + (tamCol2 / 2)) {
    colSelect = 2;
  }
  if (mouseX > posXcol3 - (tamCol3 / 2) && mouseX < posXcol3 + (tamCol3 / 2) &&
    mouseY > posYcol3 - (tamCol3 / 2) && mouseY < posYcol3 + (tamCol3 / 2)) {
    colSelect = 3;
  }
  if (mouseX > posXcol4 - (tamCol4 / 2) && mouseX < posXcol4 + (tamCol4 / 2) &&
    mouseY > posYcol4 - (tamCol4 / 2) && mouseY < posYcol4 + (tamCol4 / 2)) {
    colSelect = 4;
  }
  if (mouseX > posXcol5 - (tamCol5 / 2) && mouseX < posXcol5 + (tamCol5 / 2) &&
    mouseY > posYcol5 - (tamCol5 / 2) && mouseY < posYcol5 + (tamCol5 / 2)) {
    colSelect = 5;
  }
  if (mouseX > posXcol6 - (tamCol6 / 2) && mouseX < posXcol6 + (tamCol6 / 2) &&
    mouseY > posYcol6 - (tamCol6 / 2) && mouseY < posYcol6 + (tamCol6 / 2)) {
    colSelect = 6;
  }
}